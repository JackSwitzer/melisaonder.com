...
/* ── VARIANT 1: Unoptimized raw JPGs (bypasses Next.js compression) ── */
    ...
    return (
      <div ref={containerRef} tabIndex={-1}
        ...
        <div className="fixed top-3 right-3 z-50 px-2 py-1 text-[10px] tracking-wider uppercase rounded"
             style={{ backgroundColor: c.pink, color: c.bg }}>
          Variant 1: Unoptimized
        </div>
  ...
  return (
    <div ref={containerRef} tabIndex={-1}
      ...
      <div className="flex-1 relative min-h-0 mx-2 md:mx-4 mb-2 md:mb-4">
        {/* KEY CHANGE: unoptimized prop bypasses Next.js image compression */}
        <Image
          key={look.src}
          src={look.src}

    ...
    <main className="min-h-screen bg-beige-pink flex flex-col">
      ...
      <section className="pt-32 pb-8 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-warm-white p-6 md:p-8 rounded-lg border-l-4 border-plum">
            ...
            <p className="text-deep-brown/70 leading-relaxed mb-6">
              Formal legal argument challenging the Supreme Court of Canada's ruling on mandatory SOIRA registration. This structured appellate brief includes a statement of facts, issues, and legal argument citing precedent cases.
            </p>
            <a
              href="/papers/appellant-factum.pdf"
              download
              className="inline-flex items-center gap-2 px-4 py-2 bg-plum text-white rounded-md hover:bg-plum/80 transition-colors"
            >
              <DownloadIcon />
      ...
      <section className="flex-1 px-6 pb-8">
        <div className="max-w-5xl mx-auto h-full">
          <div className="bg-warm-white rounded-lg overflow-hidden shadow-lg h-[70vh] min-h-[500px]">
            <iframe
              src="/papers/appellant-factum.pdf"

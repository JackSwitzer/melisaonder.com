        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-warm-white p-6 md:p-8 rounded-lg border-l-4 border-pink-accent">
            <h1 className="font-serif text-2xl md:text-3xl text-deep-brown mb-3 tracking-wide">
              Policy Briefing: Child Marriage in India
            </h1>
            <div className="flex flex-wrap gap-4 text-sm mb-4">
              <span className="text-olive-green font-medium">PO220 - Poverty & Inequality in the Global South</span>
              <span className="text-deep-brown/50">|</span>
              <span className="text-deep-brown/70">October 2023</span>
            </div>
            <p className="text-deep-brown/70 leading-relaxed mb-6">
              Policy analysis addressing the socio-economic, psychological, and health consequences of child marriages in India, with recommendations for culturally-sensitive policy measures.
            </p>
            <a
      ...
      <section className="flex-1 px-6 pb-8">
        <div className="max-w-5xl mx-auto h-full">
          <div className="bg-warm-white rounded-lg overflow-hidden shadow-lg h-[70vh] min-h-[500px]">
            <iframe
              src="/papers/policy-briefing-child-marriage.pdf"

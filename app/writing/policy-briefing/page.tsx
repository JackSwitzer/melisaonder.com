        ...
        <section className="pt-28 pb-8 px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
              <div>
                <p className="text-xs tracking-[0.3em] uppercase font-light mb-3" style={{ color: colors.warmBrown }}>Policy Briefing</p>
                <h1 className="font-serif-display text-3xl lg:text-4xl font-light mb-4">Child Marriage in India</h1>
                <p className="text-sm font-light" style={{ color: colors.olive }}>PO220 · October 2023</p>
              </div>
              <a href="/papers/policy-briefing-child-marriage.pdf" download className="inline-flex items-center gap-3 px-6 py-3 text-sm font-light tracking-wide transition-all hover:gap-4" style={{ backgroundColor: colors.olive, color: colors.cream }}>
                <DownloadIcon />
                Download PDF
              </a>
            </div>
            ...
            <p className="text-base font-light leading-relaxed max-w-3xl" style={{ opacity: 0.75 }}>
              Policy analysis addressing the socio-economic, psychological, and health consequences of child marriages in India. Includes recommendations for culturally-sensitive policy measures and interventions.
            </p>
          </div>
        </section>
        ...
        <section className="flex-1 px-8 pb-12">
          <div className="max-w-6xl mx-auto h-full">
            <div className="rounded-sm overflow-hidden h-[75vh] min-h-[600px]" style={{ backgroundColor: colors.creamAlt, boxShadow: `0 4px 20px ${colors.nearBlack}10` }}>
              <iframe src="/papers/policy-briefing-child-marriage.pdf#toolbar=1&navpanes=0&view=FitH" className="w-full h-full border-0" title="Policy Briefing: Child Marriage in India" />
            </div>
          </div>
        </section>

        ...
        <section className="pt-28 pb-8 px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
              <div>
                <p className="text-xs tracking-[0.3em] uppercase font-light mb-3" style={{ color: colors.warmBrown }}>Op-Ed</p>
                <h1 className="font-serif-display text-3xl lg:text-4xl font-light mb-4">The Hidden Story Behind Our Food</h1>
                <p className="text-sm font-light" style={{ color: colors.olive }}>PO316 · 2024</p>
              </div>
              <a href="/papers/op-ed-factory-farming.pdf" download className="inline-flex items-center gap-3 px-6 py-3 text-sm font-light tracking-wide transition-all hover:gap-4" style={{ backgroundColor: colors.olive, color: colors.cream }}>
                <DownloadIcon />
                Download PDF
              </a>
            </div>
            ...
            <p className="text-base font-light leading-relaxed max-w-3xl" style={{ opacity: 0.75 }}>
              Opinion piece examining the environmental toll of factory farming in Canada. Proposes policy measures including subsidy redirection, environmental regulations, and green label certification programs.
            </p>
          </div>
        </section>
        ...
        <section className="flex-1 px-8 pb-12">
          <div className="max-w-6xl mx-auto h-full">
            <div className="rounded-sm overflow-hidden h-[75vh] min-h-[600px]" style={{ backgroundColor: colors.creamAlt, boxShadow: `0 4px 20px ${colors.nearBlack}10` }}>
              <iframe src="/papers/op-ed-factory-farming.pdf#toolbar=1&navpanes=0&view=FitH" className="w-full h-full border-0" title="The Hidden Story Behind Our Food" />
            </div>
          </div>
        </section>
